...
function PaoLib:Window(text,mainclr,cls)
	...
	function PaoLib:Notification(titletext, desctext, btntext)
	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text,ico)
			...
			function ChannelContent:Button(text, callback)
				...
				function ButtonFunc:UpdateText(tochange)
					Button.Text = tochange
				end
				return ButtonFunc
			end
			...
			function ChannelContent:Label(text)
				...
				function labelfunc:Update(tochange)
					Label.Text = tochange
				end
				return labelfunc
			end
